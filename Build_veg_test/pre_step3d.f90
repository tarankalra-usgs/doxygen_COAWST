...
!
!svn $Id: pre_step3d.F 787 2016-05-04 22:29:40Z arango $
!=======================================================================
...
!
!
!  Add contribution for vertical stokes velocity advection.
!
!
...
!
          DO i=Istr,Iend
            DO k=1,N(ng)-1
              ...
              FCs(i,k)=cff1*t(i,j,k  ,nstp,itrc)+                       &
