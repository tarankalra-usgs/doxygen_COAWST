      MODULE mod_strings
!
!svn $Id: mod_strings.F 1368 2011-01-21 00:34:18Z kate $
!================================================== Hernan G. Arango ===
...
!
        ...
        integer, parameter :: Iceregion = 51
     ...
     &      'Advection of ice tracers..........................'/)
        ...
        character (len=80) :: my_fc = "/share/apps/openmpi/bin/mpif90"
        character (len=160) :: my_fflags = " -fastsse -Mipa=fast -tp k8-64 -Mfree"
